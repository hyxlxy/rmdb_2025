...
public:
    ...
    std::string GetInfo()
    {
        ...
        case AbortReason::READ_WRITE_CONFLICT:
        {
            return "Transaction " + std::to_string(txn_id_) + " aborted due to read-write conflict\n";
        }
        break;

        case AbortReason::RECORD_NOT_FOUND:
        {
            return "Transaction " + std::to_string(txn_id_) + " aborted because record not found\n";
        }
        break;
