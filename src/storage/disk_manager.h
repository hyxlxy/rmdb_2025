...
class DiskManager {
   public:
    ...
    int get_open_file_fd(const std::string &file_name);
    ...
    /*检查点操作*/
    void write_check_point(int fd, char *check_point_data, int size);
   ...
   private:
    ...
    std::unordered_map<std::string, int> path2refcount_;  // 文件引用计数
