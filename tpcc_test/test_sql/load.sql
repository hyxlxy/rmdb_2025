...
load tpcc_test/performance_test/table_data/warehouse.csv into warehouse;
load tpcc_test/performance_test/table_data/district.csv into district;
load tpcc_test/performance_test/table_data/customer.csv into customer;
load tpcc_test/performance_test/table_data/history.csv into history;
load tpcc_test/performance_test/table_data/new_orders.csv into new_orders;
load tpcc_test/performance_test/table_data/orders.csv into orders;
load tpcc_test/performance_test/table_data/order_line.csv into order_line;
load tpcc_test/performance_test/table_data/item.csv into item;
load tpcc_test/performance_test/table_data/stock.csv into stock;
