...
load /root/dbstart/rmdb/src/test/performance_test/table_data/warehouse.csv into warehouse;
load /root/dbstart/rmdb/src/test/performance_test/table_data/district.csv into district;
load /root/dbstart/rmdb/src/test/performance_test/table_data/customer.csv into customer;
load /root/dbstart/rmdb/src/test/performance_test/table_data/history.csv into history;
load /root/dbstart/rmdb/src/test/performance_test/table_data/new_orders.csv into new_orders;
load /root/dbstart/rmdb/src/test/performance_test/table_data/orders.csv into orders;
load /root/dbstart/rmdb/src/test/performance_test/table_data/order_line.csv into order_line;
load /root/dbstart/rmdb/src/test/performance_test/table_data/item.csv into item;
load /root/dbstart/rmdb/src/test/performance_test/table_data/stock.csv into stock;
